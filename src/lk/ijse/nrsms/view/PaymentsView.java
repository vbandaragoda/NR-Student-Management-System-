...
import lk.ijse.nrsms.controller.VPaymentsController;
...
public class PaymentsView extends javax.swing.JFrame {
    ...
    private void loadAllPayments() {
        try {
            List<Payment> paymentList = new VPaymentsController().getAllPaymnets();
            ...
            for (Payment tempPayment : paymentList) {
                model.addRow(new Object[]{
                    tempPayment.getPID(),
                    tempPayment.getSID(),
                    tempPayment.getMonth(),
                    tempPayment.getPStatus()  
                });
            }
