...
import lk.ijse.nrsms.controller.SessionController;
 ...
 * @author vimuk
 */
public class SessionManagerView extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("SEID");
        jPanel1.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 160, 120, 30));
        jPanel1.add(txtName, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 190, 180, 40));

        txtUpdate.setFont(new java.awt.Font("Lato", 1, 18)); // NOI18N
        txtUpdate.setText("Update");
        jPanel1.add(txtUpdate, new org.netbeans.lib.awtextra.AbsoluteConstraints(720, 450, 230, 40));

        jLabel4.setFont(new java.awt.Font("Lato", 0, 15)); // NOI18N
        jLabel4.setText("Name");
        jPanel1.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 160, 120, 30));
        ...
        jPanel1.add(txtSEID, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 190, 180, 40));

        jLabel5.setFont(new java.awt.Font("Lato", 0, 15)); // NOI18N
        jLabel5.setText("Time");
        jPanel1.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(600, 160, 120, 30));
        jPanel1.add(txtTime, new org.netbeans.lib.awtextra.AbsoluteConstraints(600, 190, 180, 40));
        jPanel1.add(txtDay, new org.netbeans.lib.awtextra.AbsoluteConstraints(840, 190, 180, 40));

        jLabel6.setFont(new java.awt.Font("Lato", 0, 15)); // NOI18N
        jLabel6.setText("Day");
        jPanel1.add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(840, 160, 120, 30));
        jPanel1.add(txtCenter, new org.netbeans.lib.awtextra.AbsoluteConstraints(1080, 190, 180, 40));

        jLabel7.setFont(new java.awt.Font("Lato", 0, 15)); // NOI18N
        jLabel7.setText("Center");
        jPanel1.add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(1080, 160, 120, 30));
        ...
        jPanel1.add(btnSave, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 450, 230, 40));
        ...
        tbl.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Record Number", "Session ID", "Time", "Day", "Center"
            }
        ));
        jScrollPane1.setViewportView(tbl);

        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 330, 660, 90));
        ...
        jPanel1.add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(590, 260, 200, 40));
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        ...
        try {
            ...
            boolean isSaved = new SessionController().saveSession(s1);
            if(isSaved){
            ...
            Logger.getLogger(SessionManagerView.class.getName()).log(Level.SEVERE, null, ex);
    ...
    private void txtSEIDActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtSEIDActionPerformed
        if(txtSEID.getText().trim().length()>0){
            try {
                Session OBJ = new SessionController().getSession(txtSEID.getText().trim());
                if(OBJ!=null){
                    txtName.setText(OBJ.getName());
                    txtTime.setText(OBJ.getSTime());
                    txtDay.setText(OBJ.getDay());
        ...
        JOptionPane.showMessageDialog(this, "Please insert an SEID", "Error", JOptionPane.ERROR_MESSAGE);
        }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        int rowNumber = isAlreadyExists(txtSEID.getText());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SessionManagerView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SessionManagerView().setVisible(true);
            }
        });
    }
