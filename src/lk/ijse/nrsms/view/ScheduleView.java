...
import lk.ijse.nrsms.controller.VScheduleController;
...
public class ScheduleView extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Record Number", "SCHID", "Date", "Start", "End"
            }
        ) {
    ...
    private void loadAllSchedules() {
        try {
            List<Schedule> scheduleList = new VScheduleController().getAllSchedules();
            
            DefaultTableModel model = (DefaultTableModel) jTable1.getModel();
            
            for(Schedule tempSchedule : scheduleList){
            model.addRow(new Object[]{
                tempSchedule.getSCHD(),
                tempSchedule.getSCHID(),
                tempSchedule.getSHDate(),
                tempSchedule.getSHStart(),
                tempSchedule.getSHEnd()
          });
            }
