...
import lk.ijse.nrsms.controller.V2StudentSearchController;
import lk.ijse.nrsms.controller.VStudentsController;
...
public class SearchView extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel5.setText("© Angel's Idea Software Solutions");
        jPanel1.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(570, 740, 230, 30));
        ...
        jLabel19.setText("Student Search");
        jLabel19.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        jPanel3.add(jLabel19, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 10, 130, 30));

        jPanel1.add(jPanel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(1190, 100, 150, 50));
        ...
        jButton3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/lk/ijse/nrsms/view/back.png"))); // NOI18N
        ...
        jPanel4.add(jButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 0, 50, 60));
        ...
        jLabel4.setText("Nayanajith Rathnayaka Student Managment System");
        jPanel5.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 10, -1, 40));

        jPanel4.add(jPanel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 1370, 60));

        jLabel17.setFont(new java.awt.Font("Square721 BT", 1, 36)); // NOI18N
        jLabel17.setText("Search Student");
        jPanel4.add(jLabel17, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 80, 300, 40));
        ...
        jPanel4.add(txtSID, new org.netbeans.lib.awtextra.AbsoluteConstraints(1160, 100, 150, 40));
        ...
        tblRegistration.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Student ID", "Name", "Address", "School", "Class", "Tele M", "Tele H"
            }
        ));
        ...
        jPanel4.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 140, 1240, 380));

        jLabel11.setIcon(new javax.swing.ImageIcon(getClass().getResource("/lk/ijse/nrsms/view/cover2.png"))); // NOI18N
        jPanel4.add(jLabel11, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 520, 1370, 250));

        jLabel18.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel18.setText("Input anything");
        jPanel4.add(jLabel18, new org.netbeans.lib.awtextra.AbsoluteConstraints(1180, 70, 110, 30));
    ...
    private void txtSIDKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtSIDKeyReleased
        ...
        DefaultTableModel table = (DefaultTableModel)tblRegistration.getModel();
        String search = txtSID.getText();
        TableRowSorter<DefaultTableModel> tr = new TableRowSorter<DefaultTableModel>(table);
        tblRegistration.setRowSorter(tr);
    ...
    private void loadAllStudents() throws SQLException, ClassNotFoundException {
        ...
        List<Student> studentList = new V2StudentSearchController().getAllStudents();
            ...
            for (Student tempStudent : studentList) {
                ...
                model.addRow(new Object[]{
                    ...
                    tempStudent.getSchool(),
                    tempStudent.getTClass(),
                    tempStudent.getTeleM(),
                    tempStudent.getTeleH()
               });
