...
import lk.ijse.nrsms.controller.VHomeworkController;
 ...
 * @author vimuk
 */
public class HomeworkView extends javax.swing.JFrame {

    /**
     * Creates new form HomeworkView
     */
    public HomeworkView() {
        initComponents();
        loadAllHomeworks();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(HomeworkView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new HomeworkView().setVisible(true);
            }
        });
    }
    ...
    private void loadAllHomeworks() {
        try {
            List<Homework> homeworkList = new VHomeworkController().getAllHomeworks();
            
            DefaultTableModel model = (DefaultTableModel) jTable1.getModel();
            
            for(Homework tempHomework : homeworkList){
            
            model.addRow(new Object[]{
            
                tempHomework.getHWID(),
                tempHomework.getHID(),
                tempHomework.getSID(),
                tempHomework.getStatus()
                });
            }
        } catch (SQLException ex) {
            Logger.getLogger(HomeworkView.class.getName()).log(Level.SEVERE, null, ex);
        } catch (ClassNotFoundException ex) {
            Logger.getLogger(HomeworkView.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
